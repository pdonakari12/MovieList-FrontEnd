...
export default function TypeAheadActors(props:typeAheadActorsProps){
   ...
   const [draggedElement, setDraggedElement]=useState<actorMovieDTO| undefined>();
  ...
  function handleDragOver(actor:actorMovieDTO){
      ...
      if(actor.id!==draggedElement.id){
        ...
        const actorsIndex=props.actors.findIndex(x=>x.id===actor.id);

        const actors=[...props.actors];
        actors[actorsIndex]=draggedElement;
...
// function AxiosResponse<T>(): ((reason: any) => PromiseLike<never>) | null | undefined {
