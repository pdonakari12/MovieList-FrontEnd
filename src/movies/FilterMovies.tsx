...
export default function FilterMovies(){
 ...
 const [totalAmountOfPages,setTotalAmounfOfPages]=useState(0);
 ...
 useEffect(()=>{
   ...
   if(query.get('page')){
    initialValues.page=parseInt(query.get('title')!,10);    
   }
 ...
 function searchMovies(values:filterMoviesForm){
    ...
    .then((response:AxiosResponse<movieDTO[]>)=>{
        ...
        setTotalAmounfOfPages(Math.ceil(records/values.recordsPerPage));
             ...
             <Form>
                 <div className="row gx-3 align-items-center mb-3">
                     ...
                     <div className="col-auto">
                         ...
                         {...formikProps.getFieldProps("genreTd")}>
                     ...
                     <div className="col-auto">
                         <div className="form-check">
                             ...
                             <label className="form-check-lable" htmlFor="upcomingReleases">Upcoming Releases</label>
                     ...
                     <div className="col-auto">
                         <div className="form-check">
                             ...
                             <label className="form-check-lable" htmlFor="inTheaters">In Theaters</label>
