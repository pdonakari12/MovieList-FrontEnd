...
import { convertActorToFormData, convertMovieToFormData } from "../utils/formDataUtils";
...
export default function CreateMovie(){
    ...
    const[nonSelectedMovieTheaters,setNonSelectedMoviesTheaters]=useState<movieTheaterDTO[]>([]);
  ...
  const history=useHistory();
    ...
    useEffect(()=>{
        ...
        .then((response:AxiosResponse<moviesPostGetDTO>)=>{
          ...
          setNonSelectedMoviesTheaters(response.data.moviesTheaters);
        setloading(false);
        })
    },[]) 
